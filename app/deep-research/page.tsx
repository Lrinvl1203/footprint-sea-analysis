    ...
    national: [
      {
        ...
        url: 'https://heavyindustries.gov.in/pli-auto',
        note: '전기지게차 제품으로 포지셔닝 시 적용 가능성 높음',
      },
      {
        ...
        eligible: '기계 제조업 전 분야',
        url: 'https://www.investindia.gov.in/foreign-direct-investment',
        note: 'FEMA 준수 조건',
      },
      {
        scheme: '관세 면제 (Capital Goods Import)',
        authority: '재무부 (CBIC)',
        rate: '기계설비 기본관세 0–7.5%',
        threshold: '제조업 실제 사용자 조건',
        eligible: '생산용 기계·설비 수입 시 IGST 환급 가능',
        url: 'https://www.cbic.gov.in',
        note: 'GST ITC (Input Tax Credit) 로 운전자금 영향 주의',
      },
    ],
    stateLevel: [
      {
        ...
        url: 'https://investtn.in/industrial-policy',
        note: '타밀나두 산업촉진청(TIDCO) 통해 신청. 지게차 제조는 "Capital Goods / Engineering" 분류 적용 가능',
      },
      {
        ...
        note: 'Pune Chakan 구역 — 신청은 MAITRI 포털 통해 온라인 처리',
      },
    ],
  },
  supplyChain: {
    ...
    powertrain: [
      { name: 'Cummins India Ltd',           product: 'IC 엔진 (LPG·디젤·CNG 산업용)',   location: '푸네 (Phaltan)',   url: 'https://www.cumminsind.com', note: '글로벌 Cummins 100% 자회사. B3.3/QSF3.8 지게차용 엔진 공급' },
      { name: 'Dana India Pvt Ltd',          product: '드라이브 액슬·추진축',              location: '푸네 (Chakan)',   url: 'https://www.dana.com/in', note: '지게차·건설기계 액슬 제조 실적' },
      { name: 'ZF CV Control Systems India', product: '자동변속기 (6HP/8HP 계열)',         location: '푸네 (Pimpri)',   url: 'https://www.zf.com/india', note: '중장비용 변속기는 독일 수입 병행' },
      { name: 'Mahindra Powerol',            product: '산업용 엔진·발전기 세트',           location: '나시크 / 첸나이', url: 'https://www.mahindrapowerol.com', note: '백업 전원 및 경량 지게차 엔진 옵션' },
      { name: 'WABCO India (ZF 흡수합병)',   product: '브레이크 시스템·액추에이터',        location: '첸나이 (Ambattur)', url: 'https://www.zf.com/india', note: '지게차 브레이크 시스템 현지 공급 가능' },
    ],
    hydraulics: [
      { name: 'Parker Hannifin India',       product: '유압 펌프·밸브·실린더 전 계열',   location: '푸네 (Kothrud)',  url: 'https://ph.parker.com/in', note: '연구개발+제조 거점. 지게차 유압시스템 풀 공급 가능' },
      { name: 'Wipro Infrastructure Engineering', product: '유압 실린더 (Tilt/Lift)',   location: '푸네 / 방갈로르', url: 'https://www.wipro.com/infrastructure-engineering', note: '지게차·건설기계용 실린더 국내 제조 다수' },
      { name: 'Bosch Rexroth India',         product: '유압 모터·펌프·비례 밸브',        location: '아흐메다바드',    url: 'https://www.boschrexroth.com/en/xc/countries/india', note: '자동화 시스템 연계. 비례 밸브 현지 조립' },
      { name: 'Yuken India Ltd',             product: '유압 밸브·펌프',                  location: '방갈로르',        url: 'https://www.yuken-india.com', note: '일본 Yuken 기술 이전. 인도 자체 제조' },
      { name: 'Eaton India',                 product: '유압 호스·피팅·밸브',             location: '푸네',            url: 'https://www.eaton.com/in', note: '유압 연결 부품 현지 제조' },
    ],
    electrical: [
      { name: 'Motherson Sumi Wiring India', product: '와이어 하네스 (전체 전장)',        location: '노이다 / 푸네 / 첸나이', url: 'https://www.mothersonsumi.com', note: '아시아 최대 하네스 그룹. 지게차 맞춤 설계 가능' },
      { name: 'Aptiv India (구 Delphi)',     product: '전장 하네스·커넥터',              location: '첸나이 (Mahindra City)', url: 'https://www.aptiv.com', note: '첸나이 자동차 클러스터 인접' },
      { name: 'Siemens India',               product: 'SINAMICS 인버터·모터·PLC',        location: '뭄바이 / 첸나이', url: 'https://www.siemens.co.in', note: '전기지게차용 트랙션 드라이브 공급 실적' },
      { name: 'ABB India Ltd',               product: '트랙션 모터·드라이브·충전기',     location: '방갈로르 / 첸나이', url: 'https://new.abb.com/in', note: '전기지게차 전환 핵심 파트너 옵션' },
      { name: 'Yazaki India Pvt Ltd',        product: '자동차 와이어 하네스',            location: '첸나이 (Sriperumbudur)', url: 'https://www.yazaki-group.com/global/locations/', note: '일본계. 첸나이 단지 내 제조' },
    ],
    others: [
      { name: 'MRF Ltd',                     product: '산업용 솔리드/공기압 타이어',     location: '첸나이 (본사+제조)', url: 'https://www.mrftyres.com', note: '인도 1위 타이어. 지게차 전용 솔리드 타이어 라인업 보유' },
      { name: 'Apollo Tyres Ltd',            product: '산업차량·지게차용 타이어',        location: '첸나이 / 바로다', url: 'https://www.apollotyres.com', note: 'Solideal 계열 제품 취급' },
      { name: 'CEAT Ltd',                    product: '산업차량 타이어',                 location: '나시크',          url: 'https://www.ceat.com', note: 'RPG 그룹 계열' },
      { name: 'Tata AutoComp Systems',       product: '시트 어셈블리·폼 패드',          location: '푸네 / 첸나이',   url: 'https://www.tataautcomp.com', note: '자동차 시트 → 산업차량 맞춤 개발 가능' },
      { name: 'Faurecia India',              product: '자동차·산업용 시트 시스템',       location: '푸네',            url: 'https://www.forvia.com/en/india', note: '에르고노믹 산업 시트. 글로벌 표준' },
    ],
    counterweight: [
  ...
  industrialParks: [
    {
      ...
      url: 'https://www.sipcot.com/industrial-parks/oragadam',
    ...
    },
    {
      ...
      url: 'https://www.mahindraworldcity.com/chennai',
    ...
    },
    {
      ...
      url: 'https://www.midcindia.org/industrial-areas/pune',
      pro: '자동차+건설기계 공급망 최밀집, 엔지니어 인력풀 최고, 직접 토지매입 가능',
      con: 'JNPT까지 145km (수출 물류비 높음), 토지 희소·가격 상승',
    },
  ],
  sources: [
    { org: 'TANGEDCO', url: 'https://www.tangedco.gov.in/tariff.html', quote: 'HT Supply (Industrial) at 33kV: Fixed Charges Rs.250/kVA/Month; Energy Charges Rs.7.25/unit (2024 Tariff Order).' },
    { org: 'Invest India (DPIIT)', url: 'https://www.investindia.gov.in/foreign-direct-investment', quote: '100% FDI is permitted under the automatic route in the manufacturing sector including industrial machinery and equipment.' },
    { org: 'TIDCO Tamil Nadu', url: 'https://www.tidco.com/investor-services/', quote: 'Tamil Nadu Industrial Policy 2021 provides Ultra Mega project benefits including 50% land cost reimbursement and power tariff subsidy of Rs.1.5/unit for 10 years.' },
    { org: 'Ministry of Heavy Industries — PLI Auto', url: 'https://heavyindustries.gov.in/pli-auto', quote: 'PLI Scheme for Automobile and Auto Components offers incentives of 13-18% on incremental sales over baseline for 5 years for OEMs meeting investment threshold of Rs.2,000 crore.' },
    { org: 'JSW Steel', url: 'https://www.jsw.in/steel/flat-products', quote: 'JSW Steel Salem Works, Tamil Nadu produces Hot Rolled Coils including IS 2062 grades equivalent to SS400, with capacity of 3.6 million tonnes per year.' },
    { org: 'SIPCOT', url: 'https://www.sipcot.com', quote: 'SIPCOT Oragadam Industrial Complex Phase II offers plots ranging from 2 acres to 100 acres for large-scale manufacturing projects with all utilities in place.' },
    { org: 'Parker Hannifin India', url: 'https://ph.parker.com/in/en/products', quote: 'Parker\'s Pune facility manufactures hydraulic cylinders, pumps and valves serving construction, material handling, and industrial equipment OEMs across India.' },
    { org: 'Cummins India Ltd (Annual Report 2024)', url: 'https://www.cumminsind.com/en/about/investor-relations.html', quote: 'Cummins India manufactures B and F series industrial engines at Phaltan, Maharashtra, serving material handling, construction and power generation customers.' },
    { org: 'MIDC', url: 'https://www.midcindia.org', quote: 'MIDC Chakan Phase 2 water tariff: Rs.52/kL for industrial consumers with a minimum charge applicable on contracted demand.' },
    { org: 'Brakes India Ltd', url: 'https://www.brakesindia.com/manufacturing', quote: 'Brakes India manufactures grey iron and SG iron castings at Chennai facilities serving commercial vehicle, off-highway and industrial equipment customers globally.' },
  ],
};
